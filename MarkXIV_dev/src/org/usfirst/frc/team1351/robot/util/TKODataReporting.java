...
public class TKODataReporting implements Runnable // implements Runnable is important to make this class support the Thread (run method)
{
	...
	public void collectDriveData()
	{
		...
		try
		{
			...
			// {
			// inst.addData("Temperature", motor.getTemperature(), "p: 0" + currentPTested + " i: 0" + currentITested + " d: 0" +
			// currentDTested, id);
			// inst.addData("Out_Current", motor.getOutputCurrent(), "p: 0" + currentPTested + " i: 0" + currentITested + " d: 0" +
			// currentDTested, id);
			// inst.addData("Out_Voltage", motor.getOutputVoltage(), "p: 0" + currentPTested + " i: 0" + currentITested + " d: 0" +
			// currentDTested, id);
			// inst.addData("In_Voltage", motor.getBusVoltage(), "p: 0" + currentPTested + " i: 0" + currentITested + " d: 0" +
			// currentDTested, id);
			// } else
			// {
			// inst.addData("Temperature", motor.getTemperature(), "p: " + currentPTested + " i: " + currentITested + " d: " +
			// currentDTested, id);
			// inst.addData("Out_Current", motor.getOutputCurrent(), "p: " + currentPTested + " i: " + currentITested + " d: " +
			// currentDTested, id);
			// inst.addData("Out_Voltage", motor.getOutputVoltage(), "p: " + currentPTested + " i: " + currentITested + " d: " +
			// currentDTested, id);
			// inst.addData("In_Voltage", motor.getBusVoltage(), "p: " + currentPTested + " i: " + currentITested + " d: " + currentDTested,
			// id);
			// }
			// SmartDashboard.putNumber("Temperature Jag " + id, motor.getTemperature());
			// SmartDashboard.putNumber("Out_Current Jag " + id, motor.getOutputCurrent());
